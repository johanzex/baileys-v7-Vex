...
/** is the jid a user */ export const areJidsSameUser = (jid1, jid2) =>
  jidDecode(jid1)?.user === jidDecode(jid2)?.user;
/** is the jid Meta AI */ export const isJidMetaAI = (jid) =>
  jid?.endsWith("@bot");
/** is the jid a PN user */ export const isPnUser = (jid) =>
  jid?.endsWith("@s.whatsapp.net");
/** is the jid a LID */ export const isLidUser = (jid) => jid?.endsWith("@lid");
/** is the jid a broadcast */ export const isJidBroadcast = (jid) =>
  jid?.endsWith("@broadcast");
/** is the jid a group */ export const isJidGroup = (jid) =>
  jid?.endsWith("@g.us");
/** is the jid the status broadcast */ export const isJidStatusBroadcast = (
  jid,
) => jid === "status@broadcast";
/** is the jid a newsletter */ export const isJidNewsletter = (jid) =>
  jid?.endsWith("@newsletter");
/** is the jid a hosted PN */ export const isHostedPnUser = (jid) =>
  jid?.endsWith("@hosted");
/** is the jid a hosted LID */ export const isHostedLidUser = (jid) =>
